    ...
    <div className='mt-12 h-auto w-full mb-10 cursor-pointer'>
      ...
      <div className='flex flex-wrap justify-center gap-5 sm:gap-8 md:gap-10'>
        ...
        <div className='flex flex-col items-center'>
          <img src="Frame 3.png" alt="Vertical Striped Shirt" className="w-full h-auto" />
          <img src="Frame 35 (1).png" alt="Vertical Striped Shirt" className="w-full h-auto mt-3" />
        ...
        {/* Product 2 */}
        <div className='flex flex-col items-center'>
          <img src="Frame 33 (1).png" alt="Courage Graphic T-Shirt" className="w-full h-auto" />
          <img src="Frame 39 (1).png" alt="Courage Graphic T-Shirt" className="w-full h-auto mt-3" />
        ...
        {/* Product 3 */}
        <div className='flex flex-col items-center'>
          <img src="Frame 34 (1).png" alt="Loose Fit Bermuda Shorts" className="w-full h-auto" />
          <img src="Frame 39 (1).png" alt="Loose Fit Bermuda Shorts" className="w-full h-auto mt-3" />
        ...
        {/* Product 4 */}
        <div className='flex flex-col items-center'>
          <img src="Frame 38 (1).png" alt="Faded Skinny Jeans" className="w-full h-auto" />
          <img src="Frame 41.png" alt="Faded Skinny Jeans" className="w-full h-auto mt-3" />
